...
export default function PaymentCheckout() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--sage)" }}>
      ...
      <div
        style={{ maxWidth: 980, margin: "0 auto", padding: "40px 24px 80px" }}
      >
        {/* Header */}
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            >
                ...
                >
                  {(["individual", "team"] as PlanType[]).map((p) => (
                    <button
                      ...
                      style={{
                        padding: "14px 18px",
                        border: `2px solid ${plan === p ? "var(--blue)" : "var(--border)"}`,
                        borderRadius: 10,
                        background: plan === p ? "var(--blue-light)" : "white",
                        cursor: "pointer",
                        textAlign: "left",
                        transition: "all .15s",
                        fontFamily: "Inter,sans-serif",
                    ...
                    >
                      <div
                        style={{
                          fontSize: 14,
                          fontWeight: 700,
                          color: plan === p ? "var(--blue)" : "var(--text-1)",
                          marginBottom: 3,
                        }}
                      >
              ...
              {/* Team name and organization inputs */}
              {isTeam && (
                <div
                  style={{
                    padding: "14px 24px",
            ...
            >
              ...
              >
                ...
                <button
                  ...
                  style={{
                    padding: "14px 16px",
                    border: `2px solid ${provider === "stripe" ? "var(--blue)" : "var(--border)"}`,
                    borderRadius: 10,
                    background:
                      provider === "stripe" ? "var(--blue-light)" : "white",
                    cursor: "pointer",
                    textAlign: "left",
                    transition: "all .15s",
                    fontFamily: "Inter,sans-serif",
                ...
                <button
                  ...
                  style={{
                    padding: "14px 16px",
                    border: `2px solid ${provider === "paystack" ? "var(--blue)" : "var(--border)"}`,
                    borderRadius: 10,
                    background:
                      provider === "paystack" ? "var(--blue-light)" : "white",
                    cursor: "pointer",
                    textAlign: "left",
                    transition: "all .15s",
                    fontFamily: "Inter,sans-serif",
              ...
              {provider === "paystack" && (
                ...
                >
                  ✓ Recommended for African users — pay in Naira with local
                  cards
                </div>
              )}
              {provider === "stripe" && (
            ...
            >
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                {[
                  ...
                  <div
                    key={t}
                    style={{ fontSize: 12, color: "rgba(255,255,255,.38)" }}
                  >
                    {t}
                  </div>
                ))}
