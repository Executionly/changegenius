...
export default function AdminPage() {
  ...
  const [tab, setTab] = useState<"stats" | "users" | "teams" | "questions">(
    "stats",
  );
      ...
      <div className="page">
              ...
              {[
                {
                  ...
                  sub: `${stats.paidUsers} paid`,
                },
                {
                  label: "Assessments Done",
                  value: stats.completedAssessments,
                  sub: `of ${stats.totalAssessments} started`,
                },
                {
                  label: "Teams Created",
                ...
                <tbody>
                  {users.map((u, i) => (
                    <tr
                      ...
                      style={{
                        borderBottom: "1px solid var(--border)",
                        background: i % 2 === 0 ? "white" : "var(--off)",
                      }}
                    >
                      <td
                        style={{
                      ...
                      <td
                        style={{ padding: "9px 14px", color: "var(--text-3)" }}
                      >
                        {u.email}
                      </td>
                      <td
                      ...
                      <td style={{ padding: "9px 14px" }}>
                        <span
                          style={{
                            color: u.has_paid ? "#16a34a" : "#dc2626",
                            fontWeight: 600,
                          }}
                        >
                          {u.has_paid ? "✓" : "✗"}
                      ...
                      <td style={{ padding: "9px 14px" }}>
                        <span
                          style={{
                            color: u.onboarded ? "#16a34a" : "var(--text-4)",
                            fontWeight: 600,
                          }}
                        >
                          {u.onboarded ? "✓" : "—"}
                      ...
                      >
                        {u.change_genius_role ?? "—"}
                      </td>
                      <td
                        style={{ padding: "9px 14px", color: "var(--text-4)" }}
                      >
        ...
        {tab === "questions" && (
          <div className="card" style={{ padding: 36 }}>
            ...
            <p
              style={{ fontSize: 15, color: "var(--text-2)", marginBottom: 24 }}
            >
              <strong style={{ color: "var(--navy)" }}>72 questions</strong>{" "}
              across 6 roles (10 each). Questions are defined in{" "}
              <code
                style={{
                  background: "var(--off)",
                  padding: "2px 6px",
              ...
              and are version-controlled. To update questions, edit that file
              and redeploy.
            </p>
            <div
              style={{
            ...
            >
              ⚡ Questions are loaded from code — no database required. To
              add/edit questions, modify{" "}
              <code>lib/assessment/questions.ts</code> and redeploy. Scoring
              engine is also config-driven with no hardcoded logic.
            </div>
          </div>
        )}
      </div>
